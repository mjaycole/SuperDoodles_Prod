...
// node_modules/unity-webgl/dist/index.mjs
...
function unityLoader(src, callbacks = {}) {
  ...
  if (!script) {
    let setAttrListener = function(status) {
...
var UnityWebgl = class extends UnityWebglEvent {
  constructor(canvas, config) {
    ...
    if (!config || !config.loaderUrl || !config.dataUrl || !config.frameworkUrl || !config.codeUrl) {
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        this._loader = unityLoader(this._config.loaderUrl, {
          resolve() {
            window.createUnityInstance($canvas, unityArgs, (val) => ctx.emit("progress", val)).then((ins) => {
              ctx._unity = ins;
...
export {
  UnityWebgl as default
};
/*! Bundled license information:

unity-webgl/dist/index.mjs:
  (*!
   * unity-webgl v4.4.3
   ...
   *)
*/
//# sourceMappingURL=unity-webgl.js.map
